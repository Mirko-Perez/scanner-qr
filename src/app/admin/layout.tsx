        ...
        {navItems.map(({ href, label, icon: Icon, step }) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex items-center gap-3 px-3 py-3 rounded-xl text-[13px] transition-colors duration-150 group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                active
      ...
      <div className="px-3 pb-4 mt-auto">
        ...
        {[
          ...
          <Link
            ...
            target="_blank"
            onClick={onNavigate}
            className="flex items-center gap-3 px-3 py-3 rounded-xl text-[13px] text-muted-foreground hover:bg-card hover:text-foreground transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
        ...
        {currentUser && (
          <>
            ...
            <button
              ...
              className="flex items-center gap-3 px-3 py-3 rounded-xl text-[13px] text-muted-foreground hover:bg-card hover:text-foreground transition-colors group w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
        ...
        <button
          type="button"
          onClick={onLogout}
          className="flex items-center gap-3 px-3 py-3 rounded-xl text-[13px] text-red-400/80 hover:bg-red-500/[0.08] hover:text-red-400 transition-colors group w-full mt-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-destructive"
        >
